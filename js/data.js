...
/* ---------- 5. 구매 안내문구 (주문 섹션 하단에 표시) ----------
   혹시 모를 분쟁·오해를 예방하는 고지 문구입니다.
   items 배열에 한 줄씩 자유롭게 추가/수정/삭제하세요.
   (CONFIG.returnPolicy의 반품/교환 정책도 이 목록 맨 아래에 자동으로 함께 표시됩니다) */
const NOTICES = {
  title: "구매 전 꼭 확인해 주세요",
  items: [
    "실제 상품은 사진과 다를 수 있습니다. 농산물 특성상 송이 모양·알 크기·색상에 개체 차이가 있습니다.",
    "당도(Brix)는 수확기 평균 측정치이며, 송이와 알에 따라 편차가 있을 수 있습니다.",
    "표기 무게는 포장재를 포함한 무게이며, 자연 수분 증발로 수령 시 무게가 소폭 달라질 수 있습니다.",
    "배송 중 충격으로 알 떨어짐(탈립)이 일부 발생할 수 있으나 신선도와 맛에는 문제가 없습니다.",
    "기상·수확 상황에 따라 발송 일정이 며칠 변동될 수 있습니다. 지연 시 미리 연락드립니다.",
